...
for i = 1:150%tam(1)
    ...
    ruido_aleatorio = (rand(1, 3) - 0.5)*0;
    ...
    %plot(laser_x, laser_y, 'r*', 'MarkerSize', 1);
    % Graficar líneas de los haces del láser
    ...
    hold off; 
    % Para graficar los haz del Lidar 
%     figure(2)
%     clf
%     for j = 1:10:num_readings
%         line([pose(1), laser_x(j)], [pose(2), laser_y(j)], 'Color', 'm', 'LineStyle', '--', 'LineWidth', 0.5);
%     end
end
