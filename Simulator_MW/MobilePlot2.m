...
Mobile_Graph(1) = patch('Faces',Uniciclo.platformFaces,'Vertices',robotPatch','FaceColor',[0.71 0.75 0.78],'EdgeColor','none');

robotPatch = Rz* Uniciclo.platformfVertices;
robotPatch(1,:)=robotPatch(1,:)+dx;
robotPatch(2,:)=robotPatch(2,:)+dy;

Mobile_Graph(2) = patch('Faces',Uniciclo.platformfFaces,'Vertices',robotPatch','FaceColor',[0.71 0.75 0.78],'EdgeColor','none');
...
Mobile_Graph(3) = patch('Faces',Uniciclo.wheelFaces,'Vertices',robotPatch','FaceColor','yellow','EdgeColor','none');
